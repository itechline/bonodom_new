...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    private let kPickerDialogCornerRadius:              CGFloat = 3
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(UIColor(hex: "555555"), forState: UIControlState.Normal)
        self.cancelButton.setTitleColor(UIColor(hex: "555555"), forState: UIControlState.Highlighted)
        ...
        self.doneButton.setTitleColor(UIColor(hex: "555555"), forState: UIControlState.Normal)
        self.doneButton.setTitleColor(UIColor(hex: "555555"), forState: UIControlState.Highlighted)
